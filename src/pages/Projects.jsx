    ...
    >
      <section id="portfolio" className="s-general">
        <Container>
          <Row>
            <Col lg={12}>
              <h2 className="s-header-allcaps">Some of my projects</h2>
            </Col>
          </Row>
            ...
            {Portfolios.map((item,index) => {
                return (
                  <Col className="folio-item" key={item.name}>
                    <a detail={item.detail} href={item.link} className="folio-item-thumb" target="_blank" rel="noopener noreferrer" >
